...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-14T06:20:09+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Vốn FDI tăng mạnh, mở rộng dòng vốn vào công nghệ - Tạp chí Doanh nghiệp & Đầu tư (Tạp chí Doanh nghiệp & Đầu tư, 13/08/2026); TP Hồ Chí Minh: Công bố các dự án bất động sản chưa đủ điều kiện bán nhà - Vietnam.vn (Vietnam.vn, 13/08/2026). Tiêu cực: Nhóm bất động sản phiên 13/08: 0 mã tăng / 10 mã giảm (vnstock (VCI), 13/08/2026 (truy xuất)). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
