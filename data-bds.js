...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-15T02:10:28+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Đà Nẵng: Khu nhà ở và dịch vụ Tuyên Sơn đủ điều kiện mở bán 518 căn hộ - baodautu.vn (baodautu.vn, 14/09/2026); Nhà xưởng xây sẵn hưởng lợi rõ nét từ làn sóng FDI sản xuất mới - Vietnam+ (VietnamPlus) (Vietnam+ (VietnamPlus), 14/09/2026). Tiêu cực: Nhóm bất động sản phiên 14/09: 1 mã tăng / 7 mã giảm (vnstock (VCI), 14/09/2026 (truy xuất)). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
