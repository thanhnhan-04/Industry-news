...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-16T21:28:39+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Đà Nẵng khởi công dự án nhà ở xã hội có vốn đầu tư gần 500 tỷ đồng - Vietnam+ (VietnamPlus) (Vietnam+ (VietnamPlus), 16/09/2026); Vốn FDI vào Việt Nam giảm về lượng nhưng tăng chất - Bloomberg Businessweek Vietnam (Bloomberg Businessweek Vietnam, 16/09/2026). Tiêu cực: Thanh khoản suy giảm, môi giới bất động sản buộc đổi cách bán hàng - phapluatphattrien.vn (phapluatphattrien.vn, 16/09/2026); Nhóm bất động sản phiên 16/09: 2 mã tăng / 8 mã giảm (vnstock (VCI), 16/09/2026 (truy xuất)). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "7521c99227d952df", "factor": "market", "impact": 0, "date": "2026-09-15", "srcDate": "15/09/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Amendments to the Housing Law and the Real Estate Business Law: Proposing numerous mechanisms to remove obstacles. - vietnam.vn", "desc": "Rule-based: Amendments to the Housing Law and the Real Estate Business Law: Proposing numerous mechanisms to remove obstacles. vietnam.vn Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "vietnam.vn", "url": "https://news.google.com/rss/articles/CBMipgFBVV95cUxQVFRqWW9HX0JTUHBtbk9mM3N3cGtjSXl2RXVzM3RLcDNRUWJSMVRWRmV2eVdPRkwxQUxTRFlfSGF1bFNMR0dGdWVHNk9VVkZyaFlyZVhucVp4c3lQbWVXdk5xbWVOdFluWTNkcFpoM0t0MHF2UnlnMWxFcDJFS3phYWYxQUhvZ0VrM1BYX0RqRGhJcTRDWFNjRVhyYkZXU3BnZ3dSV2hn?oc=5", "src": "news", "sourceScope": "intl"}
  ],
  // </NEWS-ITEMS>
  valuechain: [
