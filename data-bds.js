...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-20T17:17:44+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Thị trường bất động sản TP Hồ Chí Minh tăng tốc phục hồi - Doanh nghiệp Cuộc sống (Doanh nghiệp Cuộc sống, 20/07/2026); Nguồn cung bất động sản gia tăng, thêm động lực phát triển - cafeland.vn (cafeland.vn, 20/07/2026). Tiêu cực: Nhóm bất động sản phiên 20/07: 0 mã tăng / 9 mã giảm (vnstock (VCI), 20/07/2026 (truy xuất)). Có 1 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "1f113cfa54a502b3", "factor": "infra", "impact": 1, "date": "2026-07-20", "srcDate": "20/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Chiến lược bất động sản của doanh nhân Mai Hữu Tín: Gia tăng giá trị đất từ hạ tầng logistics và sản xuất - Vietnam.vn", "desc": "Rule-based: Chiến lược bất động sản của doanh nhân Mai Hữu Tín: Gia tăng giá trị đất từ hạ tầng logistics và sản xuất Vietnam.vn Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam.vn", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
