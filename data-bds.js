...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-23T00:43:47+07:00",
  factors: {
  ...
  sentiment: {
    score: 2, date: "2026-09-22",
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Sở Xây dựng phải trả lời trong 15 ngày về nhà ở đủ điều kiện bán - baohaiphong.vn (baohaiphong.vn, 22/09/2026); Sở Xây dựng phải trả lời trong 15 ngày về nhà đủ điều kiện bán - VOH (VOH, 22/09/2026). Tiêu cực: Thanh khoản bất động sản chậm, ngân hàng và người mua nhà chịu tác động thế nào? - Vietnam.vn (Vietnam.vn, 22/09/2026); Sở Xây dựng chậm trả lời hồ sơ bán nhà quá 15 ngày, DN có quyền khởi kiện - Báo VietNamNet (Báo VietNamNet, 22/09/2026). Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "1712670be69fa0d3", "factor": "infra", "impact": 1, "date": "2026-09-22", "srcDate": "22/09/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Thu hút FDI: Cần tạo giá trị gia tăng cho sản xuất - dttc.sggp.org.vn", "desc": "Rule-based: Thu hút FDI: Cần tạo giá trị gia tăng cho sản xuất dttc.sggp.org.vn Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "dttc.sggp.org.vn", "url": "https://news.google.com/rss/articles/CBMilAFBVV95cUxQNmhrUENaWXdjdDZScVMyNFRBMFAzRmJTc0dHM2R1b002RU5GS2s3VmZYa1NVeXZYZjBDR2FLWmFucnRSdnFMVXFIbFRmY0VsZVAwcFBYbnMzRV9uUFZTVDFYZWFQY0h4R0x1Y1VGeTVNN2V1NzFjQXEtajN2dUdEQUx4aGZORlN4ZW5IQ29DbFhxVVdW?oc=5", "src": "news", "sourceScope": "local"},
