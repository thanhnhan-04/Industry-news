...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-24T18:36:37+07:00",
  factors: {
  ...
  sentiment: {
    score: 2, date: "2026-09-24",
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Sở Xây dựng có 15 ngày xác nhận nhà ở hình thành trong tương lai đủ điều kiện bán - VietnamFinance (VietnamFinance, 24/09/2026); Nhà ở xã hội tăng mạnh nguồn cung, vì sao có dự án vẫn khó bán? - tapchikinhtetaichinh.vn (tapchikinhtetaichinh.vn, 24/09/2026). Tiêu cực: Đổi mới chính sách ưu đãi đầu tư, siết điều kiện chỉ định thầu - Vietnam.vn (Vietnam.vn, 24/09/2026); Nhóm bất động sản phiên 23/09: 1 mã tăng / 7 mã giảm (vnstock (VCI), 23/09/2026 (truy xuất)). Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "31a3d327cb0edb56", "factor": "supply", "impact": 2, "date": "2026-09-24", "srcDate": "24/09/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Nhà ở xã hội tăng mạnh nguồn cung, vì sao có dự án vẫn khó bán? - tapchikinhtetaichinh.vn", "desc": "Rule-based: Nhà ở xã hội tăng mạnh nguồn cung, vì sao có dự án vẫn khó bán? tapchikinhtetaichinh.vn Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "tapchikinhtetaichinh.vn", "url": "https://news.google.com/rss/articles/CBMiqAFBVV95cUxNWnJrQUJLNFh3NnB2ZnpHTDBIckRxcjUxYlQ4bnVTdE9ub3B4aDNUaDAtMGlTcnBoUHo3VV8ydmpHZWlIc3FWell2bGdfeFBOc3VCVVRETGpDcTdrdGk1VkNHOVREbklpaUlOX1B0bTRhZk1tSENULU5zMTNTQ3oxZzBfa1JaTDlmbklhTWZfNmJFRmJvdkdob3lCNGhhVDNOVDVGUWJyT2c?oc=5", "src": "news", "sourceScope": "local"},
