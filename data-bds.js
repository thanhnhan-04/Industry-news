...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-17T08:40:46+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Lãi suất hạ nhiệt nhưng tín dụng bất động sản vẫn chịu sức ép - thuonghieucongluan.com.vn (thuonghieucongluan.com.vn, 17/08/2026); Bất động sản công nghiệp Việt Nam thích ứng với xu hướng thu hút FDI chất lượng cao - CafeBiz (CafeBiz, 17/08/2026). Có 5 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "b21046f8a55f50e7", "factor": "credit", "impact": 0, "date": "2026-08-17", "srcDate": "17/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "'Không nên kiểm soát tín dụng bất động sản theo cách cào bằng' - vietnambiz.vn", "desc": "Rule-based: 'Không nên kiểm soát tín dụng bất động sản theo cách cào bằng' vietnambiz.vn Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "vietnambiz.vn", "url": "https://news.google.com/rss/articles/CBMipgFBVV95cUxONjZTbnFfTnpOa0ZpVk9HMEZraS1NM1JQbjBPWVBJQkdrTXRGajBIRFBKUDJRWE0wdXUzRTZrQzh1QVNvYnk1dHh5eXJDY2JpOVExenF6akk0RldXeEhUMmZxMDVpcUJNbkJBd0s2X204TnEtN0d0UEVGZFlTS1Q1N2Q1UVAzYVQ0aVZrd2xIZGNUWkQxeVI0ODM4Zlk5YkVJT3FBOWFR?oc=5", "src": "news", "sourceScope": "local"},
