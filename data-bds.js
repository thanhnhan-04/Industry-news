...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-14T20:50:23+07:00",
  factors: {
  ...
  sentiment: {
    score: 2, date: "2026-09-14",
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Đà Nẵng: Khu nhà ở và dịch vụ Tuyên Sơn đủ điều kiện mở bán 518 căn hộ - Baodautu.vn (Baodautu.vn, 14/09/2026); Nhà xưởng xây sẵn hưởng lợi rõ nét từ làn sóng FDI sản xuất mới - Vietnam+ (VietnamPlus) (Vietnam+ (VietnamPlus), 14/09/2026). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
