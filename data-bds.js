...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-20T23:58:46+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Thị trường bất động sản TP Hồ Chí Minh tăng tốc phục hồi - Doanh nghiệp Cuộc sống (Doanh nghiệp Cuộc sống, 20/07/2026); Quyết định 4216/QĐ-UBND TP Hồ Chí Minh 2026 giao kế hoạch đầu tư công hỗ trợ lãi vay - LuatVietnam (LuatVietnam, 20/07/2026). Tiêu cực: VN-Index bốc hơi 44 điểm, SHB giảm sàn, cổ phiếu lao dốc diện rộng - Vietnam.vn (Vietnam.vn, 20/07/2026); Nhóm bất động sản phiên 20/07: 0 mã tăng / 10 mã giảm (vnstock (VCI), 20/07/2026 (truy xuất)). Có 1 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "5938d0dc606477b7", "factor": "legal", "impact": 1, "date": "2026-07-20", "srcDate": "20/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Hà Nội đặt mục tiêu khởi công toàn bộ 114 dự án nhà ở xã hội trong 6 tháng cuối năm 2026 - Báo Xây dựng", "desc": "Rule-based: Hà Nội đặt mục tiêu khởi công toàn bộ 114 dự án nhà ở xã hội trong 6 tháng cuối năm 2026 Báo Xây dựng Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Báo Xây dựng", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
