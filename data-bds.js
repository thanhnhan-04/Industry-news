...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-04T21:29:30+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Đề xuất tháo gỡ cho một số dự án du lịch nghỉ dưỡng của Cần Thơ - Vietnam.vn (Vietnam.vn, 04/08/2026); Vốn FDI đăng ký mới lập kỷ lục - Báo Thanh Niên (Báo Thanh Niên, 04/08/2026). Tiêu cực: Đà Nẵng siết quản lý nhà ở xã hội, cảnh báo người dân trước không tin \"suất ngoại giao\" - Thời Báo Ngân… (Thời Báo Ngân Hàng, 04/08/2026). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "0a73ba1fe7260fae", "factor": "infra", "impact": 1, "date": "2026-08-04", "srcDate": "04/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Vốn FDI đăng ký mới lập kỷ lục - Báo Thanh Niên", "desc": "Rule-based: Vốn FDI đăng ký mới lập kỷ lục Báo Thanh Niên Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Báo Thanh Niên", "url": "https://news.google.com/rss/articles/CBMif0FVX3lxTE5qLXEwTXRvd0tlb2Y3X1pDR3gwR0Vac0RWbDNodS1qNUVoMTVIUTRyZGNqdURTdlcxZkhzMXBPUjBXYlk2bDdsc2hsb2NsZ21qM1llZlJtRVA1VWZxb1NieUFhUXB4bERxcHNqMHJrSVZNUi05U210OFYxMnA2Zzg?oc=5", "src": "news", "sourceScope": "local"},
