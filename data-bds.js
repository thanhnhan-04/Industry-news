...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-11T04:50:15+07:00",
  factors: {
  ...
  sentiment: {
    score: 2, date: "2026-09-10",
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Tín dụng bất động sản tăng mạnh, nhưng sức mua vẫn là điểm nghẽn - thuonghieucongluan.com.vn (thuonghieucongluan.com.vn, 10/09/2026); Dòng vốn ngoại tăng mạnh qua các thương vụ M&A - happyvietnam.vnanet.vn (happyvietnam.vnanet.vn, 10/09/2026). Tiêu cực: Tín dụng bất động sản: Cần mở đúng nơi, siết đúng chỗ - Báo Hànộimới (Báo Hànộimới, 10/09/2026). Có 3 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "acd5ae1d2f58c575", "factor": "market", "impact": 2, "date": "2026-09-10", "srcDate": "10/09/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Dòng vốn ngoại tăng mạnh qua các thương vụ M&A - happyvietnam.vnanet.vn", "desc": "Rule-based: Dòng vốn ngoại tăng mạnh qua các thương vụ M&A happyvietnam.vnanet.vn Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "happyvietnam.vnanet.vn", "url": "https://news.google.com/rss/articles/CBMilgFBVV95cUxNNUx6a295MFZpUndiNlUwRmh1QWh1aXdDNzFfVFFHZGd2ZndWSWF1SVRtaURqcUpxTUtGTERIMUpzOHRob1YyRmpSRFo0aGl0bEdjLVBIMGVKNjF4dXJqTjFwMEZ1NVphZ20tZ1EzbjZfaW8wMm5XN2dKUUlEX2xEeFBOdDhBMTJuZ2dWbjF1SmV5NGdVWEE?oc=5", "src": "news", "sourceScope": "local"},
