...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-24T19:03:52+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Hàng trăm căn hộ siêu sang tại khu 'tứ giác Bến Thành' đủ điều kiện bán - VnExpress (VnExpress, 24/07/2026); Đột phá thể chế để công nghiệp tăng trưởng hai con số - Vietnam.vn (Vietnam.vn, 24/07/2026). Tiêu cực: Nhóm bất động sản phiên 24/07: 2 mã tăng / 8 mã giảm (vnstock (VCI), 24/07/2026 (truy xuất)). Có 1 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "f2f0d3cc70d3d61f", "factor": "market", "impact": 1, "date": "2026-07-24", "srcDate": "24/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Đột phá thể chế để công nghiệp tăng trưởng hai con số - Vietnam.vn", "desc": "Rule-based: Đột phá thể chế để công nghiệp tăng trưởng hai con số Vietnam.vn Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam.vn", "url": "https://news.google.com/rss/articles/CBMiggFBVV95cUxNR2pwWTE1RUozMjJkeEY3WFE5dUludjhoUlZUUkhGcE1TVmJ5d2pmNWRtazdMaHBOUEdMY3BsdUx5dUdqRW9FUlVDVkxtemRjR3hoUHl3VGI1enBmR1lnYjJtRXJHYURIUzJaN245VndZbmFaNDJwTmtPR0xGZVdoMzd3?oc=5", "src": "news", "sourceScope": "local"},
