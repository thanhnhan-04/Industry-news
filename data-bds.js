...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-31T06:45:29+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 6 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Có nhu cầu vẫn không dám mua, bất động sản cần gì để hồi phục? - Báo Dân trí (Báo Dân trí, 31/08/2026); Trái phiếu bất động sản trả lãi tới 13%/năm - CafeF (CafeF, 30/08/2026). Tiêu cực: Trái phiếu bất động sản lãi suất tới 13%/năm, áp lực đáo hạn dồn về cuối năm - MoneyF (MoneyF, 30/08/2026). Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    {"id": "5383b466d8366cd8", "factor": "market", "impact": 1, "date": "2026-08-31", "srcDate": "31/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Có nhu cầu vẫn không dám mua, bất động sản cần gì để hồi phục? - Báo Dân trí", "desc": "Rule-based: Có nhu cầu vẫn không dám mua, bất động sản cần gì để hồi phục? Báo Dân trí Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Báo Dân trí", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
