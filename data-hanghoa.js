...
window.SECTORS.hanghoa = {
  ...
  lastUpdated: "2026-09-03T21:00:13+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 5 tín hiệu mới nhất trong 3 ngày gần nhất. Tiêu cực: Đường thô ICE #11: 17.74 cent/lb (-5.1% phiên 03/09) (Yahoo Finance (SB=F), 03/09/2026 (truy xuất)); Nhóm hàng hóa phiên 03/09: 2 mã tăng / 6 mã giảm (vnstock (VCI), 03/09/2026 (truy xuất)). Có 3 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
  ...
  itemsNews: [
    {"id": "a208f23ce7f6a807", "factor": "corn", "impact": -1, "date": "2026-08-28", "srcDate": "28/08/2026", "isNew": true, "aff": ["SBT", "QNS", "VNM", "DBC", "BAF"], "title": "Giá heo giảm, lợi nhuận của các 'ông lớn' ngành chăn nuôi ra sao? - Vietnam.vn", "desc": "Rule-based: Giá heo giảm, lợi nhuận của các 'ông lớn' ngành chăn nuôi ra sao? Vietnam.vn Tác động sơ bộ: tiêu cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam.vn", "url": "https://news.google.com/rss/articles/CBMijAFBVV95cUxPZzRxWUtQeG8wQ1VuN3dZYTZRZ2xURVBJcHo3WTdqeEZpMWtoVTRfWk0tMEFGRjVtM29aYUp5R2Q1NUlocmhyNmdmMl9KYm50Sm41LVdBRXRmdER1TExtOWpNYWFzOEhFdm9FR1h1U1R3VVcxNEpqSGJTeGxqZXI4anpEX0JfMG9VSHBnMA?oc=5", "src": "news", "sourceScope": "local"}
  ],
  // </NEWS-ITEMS>
  valuechain: [
