...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-15T23:31:43+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Gỡ vướng pháp lý, tạo cú hích cho thị trường bất động sản - Vietnam.vn (Vietnam.vn, 15/08/2026); Thủ tướng Lê Minh Hưng yêu cầu ổn định lãi suất, đưa tín dụng vào đúng lĩnh vực - Vietnam+ (VietnamPlus) (Vietnam+ (VietnamPlus), 15/08/2026). Tiêu cực: VBMA: Trái phiếu mua lại trước hạn trong tháng 7 giảm 33% - Fili.vn (Fili.vn, 15/08/2026). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "85398282d5e6bfe2", "factor": "credit", "impact": 1, "date": "2026-08-15", "srcDate": "15/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Thủ tướng Lê Minh Hưng yêu cầu ổn định lãi suất, đưa tín dụng vào đúng lĩnh vực - Vietnam+ (VietnamPlus)", "desc": "Rule-based: Thủ tướng Lê Minh Hưng yêu cầu ổn định lãi suất, đưa tín dụng vào đúng lĩnh vực Vietnam+ (VietnamPlus) Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam+ (VietnamPlus)", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
