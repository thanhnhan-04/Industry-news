...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-10T17:54:22+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: SSI Research: Lợi nhuận ngân hàng tăng trưởng tích cực, nhưng tỷ lệ cho vay toàn ngành ở mức cao - doanh… (doanhnhan.baophapluat.vn, 10/08/2026); Quảng Ngãi: Phê duyệt quy hoạch chi tiết khu đô thị quy mô lớn đầu tiên tại Măng Đen - Báo Xây dựng (Báo Xây dựng, 10/08/2026). Có 1 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsPY: [
    {"factor": "market", "impact": 1, "date": "2026-08-10", "srcDate": "10/08/2026 (truy xuất)", "isNew": true, "aff": ["DXG", "HDG", "DIG", "VRE", "VHM", "NLG"], "title": "Nhóm bất động sản phiên 10/08: 8 mã tăng / 1 mã giảm", "desc": "Ý nghĩa đầu tư: Diễn biến giá nhóm — DXG +3.3%; HDG +3.0%; DIG +2.8%; VRE +2.4%; VHM -1.9%; NLG +1.8%. Dùng để soi dòng tiền và xác nhận/tương phản với luận điểm cơ bản.", "srcName": "vnstock (VCI)", "url": "https://www.hsx.vn/", "src": "py"}
  ],
  // </PY-ITEMS>
  // <NEWS-ITEMS> khối này do news_update.py tự ghi — ĐỪNG sửa tay
  itemsNews: [
    {"id": "cb689c14c61de3c3", "factor": "market", "impact": 1, "date": "2026-08-10", "srcDate": "10/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "SSI Research: Lợi nhuận ngân hàng tăng trưởng tích cực, nhưng tỷ lệ cho vay toàn ngành ở mức cao - doanhnhan.baophapluat.vn", "desc": "Rule-based: SSI Research: Lợi nhuận ngân hàng tăng trưởng tích cực, nhưng tỷ lệ cho vay toàn ngành ở mức cao doanhnhan.baophapluat.vn Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "doanhnhan.baophapluat.vn", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
    ...
    {"id": "b1c9424f92111283", "factor": "infra", "impact": 1, "date": "2026-08-10", "srcDate": "10/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Nghị quyết 10: Mở cơ hội để doanh nghiệp Việt vào chuỗi FDI - CafeF", "desc": "Rule-based: Nghị quyết 10: Mở cơ hội để doanh nghiệp Việt vào chuỗi FDI CafeF Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "CafeF", "url": "https://news.google.com/rss/articles/CBMinwFBVV95cUxOX0xPU09nSmJsUXRVcGsyZzNoSG9XYzBacWhqamgwQW9OQ3dHNHVnemIzcjBwNVdpdXRSWi0yd0RFVHdTYWdYUC1uSVdvZk5OZE9JNUJWT19QWkpRblZza1JRY21Vb2ZlWW4tOHdaV3dDSkZrNG1SOFY1ZGVwR0FYM19qblNnVkJsZ0xXUVRTZVFzS3Y4eEZfUDdaVUpvdUE?oc=5", "src": "news", "sourceScope": "local"},
