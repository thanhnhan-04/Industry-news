...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-16T21:20:10+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Đà Nẵng khởi công dự án nhà ở xã hội có vốn đầu tư gần 500 tỷ đồng - Vietnam+ (VietnamPlus) (Vietnam+ (VietnamPlus), 16/09/2026); Vốn FDI vào Việt Nam giảm về lượng nhưng tăng chất - Bloomberg Businessweek Vietnam (Bloomberg Businessweek Vietnam, 16/09/2026). Tiêu cực: Thanh khoản suy giảm, môi giới bất động sản buộc đổi cách bán hàng - phapluatphattrien.vn (phapluatphattrien.vn, 16/09/2026). Có 3 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsPY: [
    {"factor": "market", "impact": 0, "date": "2026-09-15", "srcDate": "15/09/2026 (truy xuất)", "isNew": true, "aff": ["HDG", "KBC", "KDH", "PDR", "NLG", "NVL"], "title": "Nhóm bất động sản phiên 15/09: 4 mã tăng / 4 mã giảm", "desc": "Ý nghĩa đầu tư: Diễn biến giá nhóm — HDG +1.6%; KBC -1.5%; KDH -0.6%; PDR +0.4%; NLG +0.4%; NVL +0.4%. Dùng để soi dòng tiền và xác nhận/tương phản với luận điểm cơ bản.", "srcName": "vnstock (VCI)", "url": "https://www.hsx.vn/", "src": "py"}
  ],
  // </PY-ITEMS>
