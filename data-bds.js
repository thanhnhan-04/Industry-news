...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-01T18:44:52+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Lực hút vốn FDI từ Khu kinh tế Đông Nam Nghệ An - baodautu (baodautu, 01/08/2026); FDI đổi khẩu vị, bất động sản trước chu kỳ sàng lọc mới - baodautu (baodautu, 01/08/2026). Có 7 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "5eb320a33cba44b7", "factor": "market", "impact": 0, "date": "2026-08-01", "srcDate": "01/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "TPHCM hướng đến quản lý số toàn diện - Vietnam.vn", "desc": "Rule-based: TPHCM hướng đến quản lý số toàn diện Vietnam.vn Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam.vn", "url": "https://news.google.com/rss/articles/CBMia0FVX3lxTE4yU1hDdU14cTVxZ3pESFZpTGpfSnlxQzJETUF5dzg4RERaRk5aTEFJMkFFTFAwUDFlQjE2eDFzQzlpckxRaTh3c283bHl1UVR0UVVsMzJfYTBjZWZrLVptSTJldUZjbC02LU1z?oc=5", "src": "news", "sourceScope": "local"},
    ...
    {"id": "15c604db2fe11694", "factor": "market", "impact": 0, "date": "2026-07-31", "srcDate": "31/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Today's silver prices are fluctuating, with domestic prices exceeding 1 million VND/kg. - Vietnam.vn", "desc": "Rule-based: Today's silver prices are fluctuating, with domestic prices exceeding 1 million VND/kg. Vietnam.vn Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam.vn", "url": "https://news.google.com/rss/articles/CBMingFBVV95cUxNcWdNa2FBamR6d2hBLXJRYXpaVVB2djJnNFEwM3N2QjRPRWVlVlF0ZFpOQlpCUzRpQlR3TWJ1b21hY3E1RS1LQVdxYlgwY1paNndTT0RiSjNkVVNvbkhnaS1BNmlhNnBzaWh3bUxSdXlnUE1ucmdpUnJkVHJ2NS1GSVIyZmtKbkpOWmpXaDQzZjRoTEt3ckVyanhmWS1CUQ?oc=5", "src": "news", "sourceScope": "intl"}
  ],
  // </NEWS-ITEMS>
  valuechain: [
