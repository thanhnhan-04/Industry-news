...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-09-18T02:12:29+07:00",
  factors: {
  ...
  sentiment: {
    score: 1, date: "2026-09-17",
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Gia Lai phê duyệt dự án nhà ở xã hội hơn 500 căn tại đường Nguyễn Văn Linh - Tin nhanh chứng khoán (Tin nhanh chứng khoán, 17/09/2026); Tín dụng khách sạn, khu nghỉ dưỡng được loại trừ khi kiểm soát tăng trưởng cho vay bất động sản - Báo Vi… (Báo VietNamNet, 17/09/2026). Tiêu cực: Chào bán trái phiếu khi tỉ lệ nợ vượt mức cho phép, một công ty xây dựng bị xử phạt - Laodong.vn (Laodong.vn, 17/09/2026). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "e941beeedfc2f74f", "factor": "bond", "impact": -2, "date": "2026-09-17", "srcDate": "17/09/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Chào bán trái phiếu khi tỉ lệ nợ vượt mức cho phép, một công ty xây dựng bị xử phạt - Laodong.vn", "desc": "Rule-based: Chào bán trái phiếu khi tỉ lệ nợ vượt mức cho phép, một công ty xây dựng bị xử phạt Laodong.vn Tác động sơ bộ: tiêu cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Laodong.vn", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
