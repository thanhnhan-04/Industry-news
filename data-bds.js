...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-08-30T00:50:32+07:00",
  factors: {
  ...
  sentiment: {
    score: 1, date: "2026-08-29",
    reason: "Tự động tổng hợp từ 9 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Tuyên Quang khởi công dự án nhà ở xã hội hơn 670 tỷ đồng - Vietnam+ (VietnamPlus) (Vietnam+ (VietnamPlus), 29/08/2026); Nhà ở xã hội mới nhất: Hà Nội khởi công dự án gần 7.000 tỷ đồng, Quảng Ninh triển khai thêm gần 1.800 că… (cafeland.vn, 29/08/2026). Tiêu cực: Đề xuất phân loại rủi ro tín dụng bất động sản thay vì siết cào bằng - Báo Dân trí (Báo Dân trí, 29/08/2026); Nhóm bất động sản phiên 28/08: 2 mã tăng / 7 mã giảm (vnstock (VCI), 28/08/2026 (truy xuất)). Có 2 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    {"id": "2ba75635da1cabc8", "factor": "credit", "impact": -1, "date": "2026-08-29", "srcDate": "29/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Đề xuất phân loại rủi ro tín dụng bất động sản thay vì siết cào bằng - Báo Dân trí", "desc": "Rule-based: Đề xuất phân loại rủi ro tín dụng bất động sản thay vì siết cào bằng Báo Dân trí Tác động sơ bộ: tiêu cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Báo Dân trí", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
    {"id": "8a8f06d215779193", "factor": "legal", "impact": 1, "date": "2026-08-29", "srcDate": "29/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Tuyên Quang khởi công dự án nhà ở xã hội hơn 670 tỷ đồng - Vietnam+ (VietnamPlus)", "desc": "Rule-based: Tuyên Quang khởi công dự án nhà ở xã hội hơn 670 tỷ đồng Vietnam+ (VietnamPlus) Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam+ (VietnamPlus)", "url": "https://news.google.com/rss/articles/CBMioAFBVV95cUxNSEYxM3NnVUFIVzFaS1ZKY0ZYMGUyWTJoRThuMFhpZGFLVXpjWWpqNWtZcVVfQndLZEF3TnJCZlE1Z2txVWllWlZzYUo3SHJOTHNDbjUtOFp4S2UyN0hUX1lBcFVJd2lPVUc5emdsWjQ1VUVnMFZ1dFFRcTJ4QW5pVWJMNDZlVlRPNGJwcm82WWNKNlJTQVZ4MG9lZjlzNlFL?oc=5", "src": "news", "sourceScope": "local"},
    {"id": "6290e66b2ad21b9f", "factor": "legal", "impact": 1, "date": "2026-08-29", "srcDate": "29/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Nhà ở xã hội mới nhất: Hà Nội khởi công dự án gần 7.000 tỷ đồng, Quảng Ninh triển khai thêm gần 1.800 căn - cafeland.vn", "desc": "Rule-based: Nhà ở xã hội mới nhất: Hà Nội khởi công dự án gần 7.000 tỷ đồng, Quảng Ninh triển khai thêm gần 1.800 căn cafeland.vn Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "cafeland.vn", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
    {"id": "9d8ef5a967c79f6a", "factor": "credit", "impact": 1, "date": "2026-08-29", "srcDate": "29/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Một số ngân hàng giảm lãi suất cho vay mua bất động sản - VOV.VN", "desc": "Rule-based: Một số ngân hàng giảm lãi suất cho vay mua bất động sản VOV.VN Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "VOV.VN", "url": "https://news.google.com/rss/articles/CBMimAFBVV95cUxOUXZ4cDdoRnh5VGVkd3dFQnVBTEpFbTZfbGR1VERwVU53WFMtQmtDbmR3MkcxRmI2dzlFZ0xSb2xlY2l3LUhkRWdsR3lCWHg0VTZMZlNYVkNCWXNxZ29jTzZZeXc1Z0E4ZDVoM1dsXzhfcERRYlZ1ai1uRnQ0cWUyeEltOFBhZVcyeTcwTTVNWUVENGh4R2o2bg?oc=5", "src": "news", "sourceScope": "local"},
    {"id": "e1c6c19d73fdf062", "factor": "credit", "impact": 1, "date": "2026-08-29", "srcDate": "29/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Lãi suất thả nổi lên 15 - 16%/năm, thanh khoản bất động sản chịu sức ép - diendandoanhnghiep.vn", "desc": "Rule-based: Lãi suất thả nổi lên 15 Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "diendandoanhnghiep.vn", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
    {"id": "0c4928a0242efc3e", "factor": "infra", "impact": 1, "date": "2026-08-29", "srcDate": "29/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Hải Phòng thu hút FDI chất lượng cao, tạo sức lan tỏa - VOV.VN", "desc": "Rule-based: Hải Phòng thu hút FDI chất lượng cao, tạo sức lan tỏa VOV.VN Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "VOV.VN", "url": "https://news.google.com/rss/articles/CBMilgFBVV95cUxQVnY1bE9mZktIU1pvZEhmOUlhcFBkeU02YWNkenAxbl9oNjBjWXQydnJaS0lRby1Xa2Vnel93engyaW14bkZwS1BpUmRzTEtmOUFyWWxTOFVkR25OOWRzNmstSTBIUDlhNml6SDQxMk43Z0NaemlaWVJ3LU5wMGZ3S0o1UWVvb2Z2XzFMRUoyczJlVlhHalE?oc=5", "src": "news", "sourceScope": "local"},
    {"id": "579b25f4d0fe7fe9", "factor": "market", "impact": 0, "date": "2026-08-28", "srcDate": "28/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Vietnam resort real estate enters new phase - Theinvestor", "desc": "Rule-based: Vietnam resort real estate enters new phase Theinvestor Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Theinvestor", "url": "https://news.google.com/rss/articles/CBMihAFBVV95cUxPcDh4V3ZLWThzUzJ4MU1xcEpqYUtSbWtyalFQNHF3UVpvV3pRZjhiSC1CM1F5Sk9YSGpmVS13TDd5eVhUT3lrSzU5dWlzbHRwLWthRzlGTWNxUW5Lb2pJTlNUUndtMGdzQ0puWE1BMHlCc2xURWF4VjV3Z3YzUHFxY2FxZFU?oc=5", "src": "news", "sourceScope": "intl"},
    {"id": "4bc937c5437f644d", "factor": "finance", "impact": 0, "date": "2026-08-27", "srcDate": "27/08/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "The success of the First Extraordinary Session of the 16th National Assembly: The National Assembly is delving deeper into the operational efficiency of the system. - Vietnam.vn", "desc": "Rule-based: The success of the First Extraordinary Session of the 16th National Assembly: The National Assembly is delving deeper into the operational efficiency of the system. Vietnam.vn Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam.vn", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "intl"}
  ],
  // </NEWS-ITEMS>
  valuechain: [
