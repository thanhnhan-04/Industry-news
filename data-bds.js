...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-26T06:33:10+07:00",
  factors: {
  ...
  sentiment: {
    score: 2, date: "2026-07-26",
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Hàng loạt dự án bất động sản TPHCM đủ điều kiện mở bán - Báo điện tử Tiền Phong (Báo điện tử Tiền Phong, 26/07/2026); Sau khi gỡ vướng pháp lý, Novaland (NVL) tăng tốc bàn giao dự án đầu tiên tại trung tâm TP.HCM - Tạp chí… (Tạp chí Nhịp sống thị trường, 25/07/2026). Tiêu cực: Nhóm bất động sản phiên 24/07: 2 mã tăng / 8 mã giảm (vnstock (VCI), 24/07/2026 (truy xuất)). Có 1 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    {"id": "ddbc2cd988607bb7", "factor": "supply", "impact": 1, "date": "2026-07-26", "srcDate": "26/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Hàng loạt dự án bất động sản TPHCM đủ điều kiện mở bán - Báo điện tử Tiền Phong", "desc": "Rule-based: Hàng loạt dự án bất động sản TPHCM đủ điều kiện mở bán Báo điện tử Tiền Phong Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Báo điện tử Tiền Phong", "url": "https://news.google.com/rss/articles/CBMilgFBVV95cUxPdWM3UGRYYXhKQnh4TWJDOGM3czFsWldUMTJrclNldVpGaVNKTDcySlM4OGNXWEhCalZRaFdwMG9GSFd3SjhjTTY1UU8zTm5EYU9NWjdtc3dYc2ZUU3ZOeXBpM0dLaURfcXlrdVVBWkZBcUtnZXZvb1RRSnNmQlRxS2xEc2VOTGhLUXR3SXFnOTd0MHZvVXc?oc=5", "src": "news", "sourceScope": "local"},
