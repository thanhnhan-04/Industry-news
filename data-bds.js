...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-29T16:42:06+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Phó Chủ tịch HĐND tỉnh Lâm Thị Hương Thành dự hội nghị công bố Quyết định kết nạp đoàn viên, thành lập C… (Vietnam.vn, 29/07/2026); Nhận diện động lực tăng trưởng GDP những tháng cuối năm - Vietnam.vn (Vietnam.vn, 29/07/2026). Tiêu cực: Thanh Hóa ra 'tối hậu thư' cho loạt dự án BĐS chậm hoàn thiện pháp lý - VietnamFinance (VietnamFinance, 29/07/2026). Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "658b615611db7977", "factor": "credit", "impact": 1, "date": "2026-07-29", "srcDate": "29/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Lãi suất tăng, bất động sản bước vào giai đoạn phân hóa mạnh - CafeBiz", "desc": "Rule-based: Lãi suất tăng, bất động sản bước vào giai đoạn phân hóa mạnh CafeBiz Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "CafeBiz", "url": "https://news.google.com/rss/articles/CBMiowFBVV95cUxNR1lFM1l5RVRVNkJBRlY2MmJLdWM5UW5XRXgzdUhVWUIxb0dXeGNSaUJaTDBNcU9VWnNOUy1MQzAwMmxWc0V6RndQZlhHa1ppNTJ1SmIxWWJKajVGdVFqNElYQUVELWxjZlhhdWxheHRxbWQ5a1hmOTJkbTBKZ2c0UTJtVE0yQkJ5VmVYaGRZUzdtWlF0SThBcDNoWWtVOVJPb2pB?oc=5", "src": "news", "sourceScope": "local"},
