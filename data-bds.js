...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-21T10:20:50+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Hà Nội tăng tốc phát triển nhà ở xã hội, phấn đấu khởi công 114 dự án trong nửa cuối năm - thuonghieucon… (thuonghieucongluan.com.vn, 21/07/2026); Hà Nội chuẩn bị khởi công đồng loạt 114 dự án nhà ở xã hội, hơn 46.000 căn sắp 'tung' ra thị trường - ng… (nguoiquansat.vn, 21/07/2026). Tiêu cực: Nhóm bất động sản phiên 20/07: 0 mã tăng / 10 mã giảm (vnstock (VCI), 20/07/2026 (truy xuất)). Có 4 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
  ...
  itemsNews: [
    ...
    {"id": "3028d6df737a646e", "factor": "infra", "impact": 1, "date": "2026-07-21", "srcDate": "21/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Dòng vốn FDI tiếp tục chọn Bắc Ninh: Niềm tin từ môi trường đầu tư và khát vọng phát triển - Doanh nghiệp và Tiếp thị", "desc": "Rule-based: Dòng vốn FDI tiếp tục chọn Bắc Ninh: Niềm tin từ môi trường đầu tư và khát vọng phát triển Doanh nghiệp và Tiếp thị Tác động sơ bộ: tích cực theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Doanh nghiệp và Tiếp thị", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
    ...
    {"id": "d5f7463e0f4f19ac", "factor": "legal", "impact": 0, "date": "2026-07-21", "srcDate": "21/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Tiềm lực chủ đầu tư dự án Khu nhà ở xã hội Á Lữ - An ninh Tiền tệ", "desc": "Rule-based: Tiềm lực chủ đầu tư dự án Khu nhà ở xã hội Á Lữ An ninh Tiền tệ Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "An ninh Tiền tệ", "url": "https://news.google.com/rss/articles/CBMinwFBVV95cUxPVmNXdmVFWkRvTi1GZ1VhTmdTeUFJWDVIdTg3NElzRHkyem9kZ0FzeWpHaXYtZFJ6TVNFZEJxUWFWTl9jUzhraGF0dWh3aEphUTZGSTZvY09iN3JMWmdnd00tYzZORlZ1SDhheEJWYVg0T1d5YXFwd1R1TDB1REVLTVlGbGd6c3hXbGtpOXlYeTVtTFF5a3FjT1l0VTRhWlk?oc=5", "src": "news", "sourceScope": "local"},
    ...
    {"id": "77954657bb0a4718", "factor": "market", "impact": 0, "date": "2026-07-21", "srcDate": "21/07/2026", "isNew": true, "aff": ["VHM", "NLG", "KDH", "DXG", "KBC"], "title": "Kiến tạo thị trường bất động sản phát triển bền vững: Minh bạch phải đi trước, kỷ cương phải đi cùng - Vietnam.vn", "desc": "Rule-based: Kiến tạo thị trường bất động sản phát triển bền vững: Minh bạch phải đi trước, kỷ cương phải đi cùng Vietnam.vn Tác động sơ bộ: trung tính/chờ kiểm chứng theo keyword; mở nguồn để kiểm chứng trước khi ra quyết định.", "srcName": "Vietnam.vn", "url": "https://news.google.?oc=5", "src": "news", "sourceScope": "local"},
