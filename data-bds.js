...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-23T05:35:33+07:00",
  factors: {
  ...
  sentiment: {
    score: 0, date: "2026-07-23",
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Gỡ vướng pháp lý cho thị trường bất động sản - Báo và Phát thanh Truyền hình Hà Nội (Báo và Phát thanh Truyền hình Hà Nội, 22/07/2026); Property market seeks broader funding sources for sustainable growth - Vietnam Investment Review - VIR (Vietnam Investment Review - VIR, 22/07/2026). Tiêu cực: Áp lực nợ xấu gia tăng trở lại - Vietnam.vn (Vietnam.vn, 23/07/2026); Dừng dự án trung tâm thử nghiệm ô tô hơn 700 tỷ tại Bắc Ninh - VietnamFinance (VietnamFinance, 22/07/2026). Có 4 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
