...
window.SECTORS.bds = {
  ...
  lastUpdated: "2026-07-27T00:35:18+07:00",
  factors: {
  ...
  sentiment: {
    ...
    reason: "Tự động tổng hợp từ 8 tín hiệu mới nhất trong 3 ngày gần nhất. Tích cực: Thị trường bất động sản TP.HCM ra sao khi loạt dự án được gỡ vướng, nguồn cung bùng nổ? - Báo Tuổi Trẻ (Báo Tuổi Trẻ, 26/07/2026); Loạt dự án bất động sản TPHCM đủ điều kiện mở bán - Kenh14.vn (Kenh14.vn, 26/07/2026). Tiêu cực: Dự thảo Luật Kinh doanh bất động sản (sửa đổi): Phân cấp mạnh mẽ, cắt giảm sâu điều kiện kinh doanh - Bá… (Báo Lâm Đồng, 26/07/2026); Nhóm bất động sản phiên 24/07: 2 mã tăng / 8 mã giảm (vnstock (VCI), 24/07/2026 (truy xuất)). Có 1 tín hiệu trung tính/chờ kiểm chứng. Đây là chấm điểm rule-based từ tin/số liệu tự động; mở nguồn để kiểm chứng trước khi ra quyết định."
  },
  items: [
    {
